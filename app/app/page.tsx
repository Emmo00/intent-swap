...
import { X, MessageSquare, ArrowLeftRight } from "lucide-react";
  ...
  return (
    <div className="h-screen bg-background text-foreground flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden relative">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 space-y-6">
              <div className="text-center space-y-4">
                ...
                <p className="font-mono text-muted-foreground max-w-md">
                  Chat your swap, confirm in wallet, see live status and history. Base network only.
                </p>
              </div>
        ...
        {/* Right Sidebar - Transaction History (Desktop) */}
        <div className="hidden md:flex w-72 lg:w-80 brutalist-border border-l-4 bg-card flex-col h-full">
          <TransactionHistory />
        </div>
        ...
        <div
          ...
          } md:hidden transition-transform duration-300 absolute right-0 z-10 h-full w-80 brutalist-border border-l-4 bg-card flex flex-col`}
        >
          <div className="flex-shrink-0 flex items-center justify-between p-3 brutalist-border border-b-4">
